...
class _DSKhoaTuState extends State<DSKhoaTu> {
  ...
  //final kUrl = 'http://192.168.2.113/daitunglam/api/khoatu';
  List<dynamic> data;
        ...
        itemBuilder: (context, index) {
          ...
          return new ListTile(
            title: new Column(
              ...
              children: <Widget>[
                new Text(
                  data[index].idctkhoatu.toString(),
                  style: new TextStyle(
                      color: Colors.red,
                      fontSize: 16.0,
...
//                  new Text(data[index].ngayketthuctu.toString(), style: new TextStyle(color: Colors.blueGrey, fontSize: 14.0),),
                new Text(
                  'Ngày bắt đầy đăng ký: ' +
                      data[index].ngaybatdaudk.toString(),
                  style: new TextStyle(color: Colors.blueGrey, fontSize: 14.0),
                ),
...
//                  new Text(data[index].ngayketthucdk.toString(), style: new TextStyle(color: Colors.blueGrey, fontSize: 14.0),),
              ...
              onTap: () {
                ...
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => DangKyKhoaTu_Page(
                          khoatu: khoatu,
                        )));
              },
            );
