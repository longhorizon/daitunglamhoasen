...
class TaoThanhVienScreen extends StatefulWidget {
  TaoThanhVienScreen({this.user, this.url});
  User user;
...
class ThanhVienState extends State<TaoThanhVienScreen> {
  Future<File> file;
  ...
  _luu() async {
    ...
    String url = widget.url + '/api/app/insert_thanhvien';
    ...
    if (statusCode == 201) {
      await showDialog<void>(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('Tạo thành viên thành công! '),
